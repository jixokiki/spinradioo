...
export default function NavbarAdmin({ view }) {
          ...
          <div className="container">
            <ul className="navbar-container animate__animated animate__slideInUp">
              ...
              <li className="navbar-list">
                <Link to="/dashboard-admin">LISTEN</Link>
              </li>
              <li className="navbar-list">
            ...
            <div className="sidebar-container">
              ...
              <ul className="sidebar-list" onClick={showSidebar}>
                <li className="sidebar-items">
                  <Link className="sidebar-link" to="/dashboard-admin">
                    LISTEN
                  </Link>
                </li>
                <li className="sidebar-items">
                ...
                <li className="sidebar-items">
                  <Link className="sidebar-link" to="/cardlistmoreadmin">
                    CARD LIST MORE
                  </Link>
                </li>
              </ul>
