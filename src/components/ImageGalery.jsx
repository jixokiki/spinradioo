...
export default function ImageGallery() {
  ...
  const images = [
    ...
    Crew10, Crew11, Crew12, Crew13, Crew14, Crew15, Crew16, Crew17,
    Crew18, Crew19, Crew20, Crew21, Crew22, Crew23, Crew24, Crew25,
    Crew26, Crew27, Crew28, Crew29, Crew30, Crew31, Crew32, Crew33,
    Crew34, Crew35, Crew36, Crew37, Crew38,
  ];
  ...
  return (
    <div className="bg-primary-1">
      <div className="container crews-container-image">
        <h1 className="title-container-image">KHI STATION CREWS</h1>
        <div className="crews-list-image">
          <button className="playImage rotate" onClick={handlePrevious} aria-label="Previous Image">
            <BsFillPlayFill />
          </button>
          <div className="crews-items-image">
            <img src={images[currentImageIndex]} alt={`Crew member ${currentImageIndex + 1}`} />
          </div>
          <button className="playImage" onClick={handleNext} aria-label="Next Image">
            <BsFillPlayFill />
          </button>
        </div>
      </div>
