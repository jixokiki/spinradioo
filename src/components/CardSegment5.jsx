...
function SpotifyEmbedSegmen5(){
    return(
        // eslint-disable-next-line jsx-a11y/iframe-has-title
        <iframe 
            style={{borderRadius:'12px'}} 
            src="https://open.spotify.com/embed/episode/2Xv0HDwuw2gXLjoZjLu0MQ?utm_source=generator&t=0" 
            width="100%" 
            height="152" 
            frameBorder="0" 
            allowfullscreen 
...
function Segmen5() {
  return (
    <div>
        <h2>OLD SEGMEN 5</h2>
        <SpotifyEmbedSegmen5/>
        <SpotifyEmbed2Segmen5/>
        <SpotifyEmbed3Segmen5/>
        <SpotifyEmbed4Segmen5/>
        <h2>LATEST SEGMEN 5</h2>
        <SpotifyEmbed5Segmen5/>
        <SpotifyEmbed6Segmen5/>
        <SpotifyEmbed7Segmen5/>
        <SpotifyEmbed8Segmen5/>
        <SpotifyEmbed9Segmen5/>
        <SpotifyEmbed10Segmen5/>
        <SpotifyEmbed11Segmen5/>
        <SpotifyEmbed12Segmen5/>
        <SpotifyEmbed13Segmen5/>
        <SpotifyEmbed14Segmen5/>
        <SpotifyEmbed15Segmen5/>
        <SpotifyEmbed16Segmen5/>
        <SpotifyEmbed17Segmen5/>
        <SpotifyEmbed18Segmen5/>
        <SpotifyEmbed19Segmen5/>
        <SpotifyEmbed20Segmen5/>
    </div>
  )
}

export default Segmen5
