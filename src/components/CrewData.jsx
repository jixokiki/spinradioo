...
//             <div key={key}>
//               <label>{`Ubah Gambar ${key}`}</label>
//               <input type="file" onChange={(e) => handleImageChange(e, key)} />
//               <img src={imageUrls[key]} alt={`Crew ${key}`} style={{ width: "100px", height: "100px" }} />
//             </div>
//           ))}
//           <h2>Add New Crew Image</h2>
...
export default function CrewData() {
  ...
  // Move the images array inside the useEffect
  const IMAGES_PER_PAGE = 3;
